...
public class t_help_center extends Model {
	 ...
	 * 新版 1-注册登录 2-产品介绍 3- 提现充值 4-更多问题
	 * @author liudong
	...
	public enum Column {
		...
		/** 金融知识  */
//		FINANCIAL_KNOWLEDGE(1,"金融知识"),
		
		/** 借款专题  */
//		LOAN_PROJECT(2,"借款专题"),
		
		/** 理财专题  */
//		INVEST_PROJECT(3,"理财专题"),
		
		/** 注册登录  */
		FINANCIAL_KNOWLEDGE(1,"注册登录"),
		
		/** 产品介绍  */
		LOAN_PROJECT(2,"产品介绍"),
		
		/** 提现充值  */
		INVEST_PROJECT(3,"提现充值"),
		
		/**更多问题*/
		MORE_ISSUE(4,"更多问题");
		
	/*	*//**注册登录*//*
		REGISTER_LOGIN(8,"注册登录"),
		
		*//**产品介绍*//*
		PRODUCT_PRESENTATION(9,"产品介绍"),

		*//**提现充值*//*
		WITHDRAW_RECHARGE(10,"提现充值"),
