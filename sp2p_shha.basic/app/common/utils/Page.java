...
public class Page  implements Serializable{
	...
	/** 显示的页面的总数 */
	public static final Integer SHOW_PAGE_COUNT_INTEGER=10;
	
	/** 分页主题1: */
	public static final Integer PAGE_SIMPLE=1;
	
	/** 分页主题2: */
	public static final Integer PAGE_ASYNCH=2;
	
	/** 默认分页主题风格 */
	public static final Integer PAGE_STYLE_DEFAULT=1;
	 ...
	 * 显示分页的页码数
	 */
	public int showPageCount = SHOW_PAGE_COUNT_INTEGER;
	/**
	 * 显示的统计标题
	 */
