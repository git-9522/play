 ...
 */
public class Invert11Actity6Service extends BaseService<t_invert_11_activity6_log> {
	/** 返现比例 **/
	public static double rate = 0.01;
	/** 开始时间 **/
	public static String start_time = new String("2017-09-30 23:59:59");
	/** 结束时间 **/
	public static String end_time = new String("2017-11-01 00:00:00");
	...
	protected Invert11Actity6Service() {
