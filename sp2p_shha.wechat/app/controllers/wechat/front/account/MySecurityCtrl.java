...
public class MySecurityCtrl extends WechatBaseController {
	...
	public static void createAccount(String hfName, String realName, String idNumber, String mobile,
		...
		result = PaymentProxy.getInstance().userRegist(Client.WECHAT.code, serviceOrderNo, userId, hfName, realName, idNumber, mobile, cardId, bankId, provId, areaId, smsCode, smsSeq);
